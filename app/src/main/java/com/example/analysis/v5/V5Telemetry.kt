...
data class V5Telemetry(
    ...
    val seedMatchesRaw: Int = 0,
    val seedRansacInliers: Int = 0,
    val seedRansacRejected: Int = 0,
    val seedRansacRms: Double = 0.0,
    val preValidationMatches: Int = 0,
    val acceptedInlierMatches: Int = 0,
    val rejectedSeedRansac: Int = 0,
    val rejectedResidual: Int = 0,
    val rejectedLocalConsistency: Int = 0,
    val rejectedCollision: Int = 0,
    val rejectedTransform: Int = 0,
    val rejectedNoCandidate: Int = 0,
    val rejectedDescriptor: Int = 0,
    val candidatesBeforeResidualGate: Int = 0,
    val candidatesAfterResidualGate: Int = 0,
    val candidatesAfterLocalGate: Int = 0,
    val candidatesAfterOneToOne: Int = 0,
